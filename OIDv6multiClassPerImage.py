...
class OIDv6(Messages):
    ...
    def download(self, args, out = True):
        ...
        if args['command'] == 'downloader':
            ...
            # Compute a class name to ID lookup table
            self._class_name_to_code = dict()
            self._class_code_to_class_name = dict()
            self._classes = []
            self._class_codes = []
            ...
            for class_name in args['classes']:
                ...
                try:
                    ...
                    self._class_name_to_code[class_name] = class_code
                    self._class_code_to_class_name[class_code] = class_name
